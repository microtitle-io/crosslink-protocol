            ...
            <div className="text">
                ...
                <div>
                    <ul className="resources">
                        ...
                        <li>[github - client]: <a href="https://github.com/microtitle-io/crosslink-protocol">https://github.com/microtitle-io/crosslink-protocol</a></li>
                        <li>[github - anchor]: <a href="https://github.com/microtitle-io/xlp_smart_contract">https://github.com/microtitle-io/xlp_smart_contract</a></li>
                    </ul>
                </div>
            </div>
        </div>
