...
import { Int64BE, Int64LE } from 'int64-buffer';

import { serialize, deserialize, deserializeUnchecked } from 'borsh';
import { Buffer } from 'buffer';

// helpers solution:
// import { getProvider, getProgram } from './helpers';
...
import idl from '../idl/register.json'; // GOOD
export const MICROTITLE_PROGRAM_ID = new PublicKey('KdWVDYMteVwTbBNZGfCkS2ayCFEWhbkBoFZxPwdqCgu');  // GOOD
...
// data schema for deserializing microtitle data:
...
export async function getAccountData(connection: Connection, account: PublicKey): Promise<AccountData> {
